...
void KernelCollector::handle_urKernelCreate(const ur_kernel_create_params_t *Params) {
...
void KernelCollector::handle_urEnqueueKernelLaunch(const ur_enqueue_kernel_launch_params_t *Params) {
...
void KernelCollector::handle_urEnqueueEventsWait(const ur_enqueue_events_wait_params_t *Params) {
...
void KernelCollector::handle_urQueueFinish(const ur_queue_finish_params_t *Params) {
  handler_t queueRef = reinterpret_cast<uintptr_t>(*Params->phQueue);
  if (queueMap.find(queueRef) != queueMap.end()) {
